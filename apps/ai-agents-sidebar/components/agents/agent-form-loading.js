...
exports.AgentFormLoading = AgentFormLoading;
var skeleton_1 = require("@/components/ui/skeleton");
/**
 * Component for the loading state of the agent form
 */
function AgentFormLoading() {
      ...
      <main className="flex-1 p-3 sm:p-4 md:p-6 overflow-auto">
        <div className="max-w-5xl mx-auto">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              <skeleton_1.Skeleton className="h-6 w-48 mb-2"/>
              <skeleton_1.Skeleton className="h-24 w-full"/>
            </div>

            <div>
              <skeleton_1.Skeleton className="h-6 w-40 mb-2"/>
              <skeleton_1.Skeleton className="h-24 w-full"/>
            </div>
          </div>
        </div>
