import { Bot, BrainCircuit, Code, Database, FileText, MessageSquare, Settings, Sparkles, Zap } from "lucide-react"
...
export const PROMPT_TOOLS: PromptTool[] = [
  { id: "variables", name: "Variáveis", icon: <Database className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "functions", name: "Funções", icon: <Code className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "examples", name: "Exemplos", icon: <FileText className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "persona", name: "Persona", icon: <Bot className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "context", name: "Contexto", icon: <BrainCircuit className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "instructions", name: "Instruções", icon: <Settings className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "format", name: "Formato", icon: <MessageSquare className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "capabilities", name: "Capacidades", icon: <Sparkles className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
  { id: "constraints", name: "Restrições", icon: <Zap className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1" /> },
]
